package br.com.company.brfood.utils.custons;
...
public class ButtonCustom extends JButton {
    ...
    public enum ButtonStyle {
        ...
        PRIMARY(new Color(0,102,255), new Color(255,255,255), new Color(2, 111, 82), new Color(4, 205, 151)),
        SUCCESS(new Color(0, 172, 126), new Color(238, 238, 238), new Color(2, 111, 82), new Color(4, 205, 151)),
